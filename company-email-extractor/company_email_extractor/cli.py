...
from company_email_extractor.excel_io import read_companies_from_excel, write_results_to_excel
from company_email_extractor.models import CompanyEmailResult
from company_email_extractor.pipeline import extract_emails_for_company
...
def _project_dir() -> Path:
    # company-email-extractor/company_email_extractor/cli.py -> company-email-extractor/
